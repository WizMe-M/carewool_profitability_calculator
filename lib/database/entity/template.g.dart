...
const TemplateSchema = CollectionSchema(
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'TemplateBlock': TemplateBlockSchema},
...
int _templateEstimateSize(
  ...
  {
    final offsets = allOffsets[TemplateBlock]!;
...
void _templateSerialize(
  ...
  writer.writeObjectList<TemplateBlock>(
    offsets[0],
    allOffsets,
    TemplateBlockSchema.serialize,
    object.blocks,
  );
...
P _templateDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readObjectList<TemplateBlock>(
            offset,
            TemplateBlockSchema.deserialize,
            allOffsets,
            TemplateBlock(),
...
extension TemplateQueryFilter
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> blocksLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> blocksIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'blocks',
        0,
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> blocksIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'blocks',
        0,
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> blocksLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> blocksLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TemplateQueryObject
    on QueryBuilder<Template, Template, QFilterCondition> {
  QueryBuilder<Template, Template, QAfterFilterCondition> blocksElement(
      FilterQuery<TemplateBlock> q) {
    return QueryBuilder.apply(this, (query) {
...
extension TemplateQueryProperty
  ...
  QueryBuilder<Template, List<TemplateBlock>, QQueryOperations>
      blocksProperty() {
    return QueryBuilder.apply(this, (query) {
...
const TemplateBlockSchema = Schema(
  name: r'TemplateBlock',
  id: -4955207184583076366,
  properties: {
    r'name': PropertySchema(
      id: 0,
      name: r'name',
  ...
  estimateSize: _templateBlockEstimateSize,
  serialize: _templateBlockSerialize,
  deserialize: _templateBlockDeserialize,
  deserializeProp: _templateBlockDeserializeProp,
);

int _templateBlockEstimateSize(
  TemplateBlock object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _templateBlockSerialize(
  ...
  writer.writeStringList(offsets[1], object.partNames);
}

TemplateBlock _templateBlockDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
P _templateBlockDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension TemplateBlockQueryFilter
  ...
  QueryBuilder<TemplateBlock, TemplateBlock, QAfterFilterCondition> nameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension TemplateBlockQueryObject
    on QueryBuilder<TemplateBlock, TemplateBlock, QFilterCondition> {}
